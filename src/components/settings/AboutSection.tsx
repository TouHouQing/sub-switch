    ...
    try {
      ...
      if (!displayVersion) {
        await settingsApi.openExternal(
          "https://github.com/TouHouQing/sub-switch/releases",
        );
        return;
      }

      await settingsApi.openExternal(
        `https://github.com/TouHouQing/sub-switch/releases/tag/${displayVersion}`,
      );
    } catch (error) {
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <img src={appIcon} alt="THQ Switch" className="h-5 w-5" />
