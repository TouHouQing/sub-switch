//! Deep link import functionality for THQ Switch
//!
//! This module implements the thqswitch:// protocol for importing configurations
...
///
/// Represents a parsed thqswitch:// URL ready for processing.
