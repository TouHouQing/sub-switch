...
//!
//! Parses thqswitch:// URLs into DeepLinkImportRequest structures.
...
/// Parse a thqswitch:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// thqswitch://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != crate::identity::DEEP_LINK_SCHEME {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected '{}', got '{scheme}'",
            crate::identity::DEEP_LINK_SCHEME
        )));
    }
