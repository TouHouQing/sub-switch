...
///
/// 原因：接管模式下 `*_MODEL` 必须由 THQ Switch 写成稳定的 Claude 角色别名，
...
"#;
    ...
    async fn codex_restore_from_backup_preserves_model_catalog_pointer() {
        ...
        // Pre-takeover Live state: config.toml points at the THQ Switch-generated
        ...
        assert!(
            ...
            "restored pointer must still reference the THQ Switch-generated catalog file"
        );
    }
