...
/// Example: `thq-switch-sync/v2/db-v6/default/manifest.json`
...
mod tests {
    ...
    fn s3_key_uses_v2_and_correct_format() {
        ...
        assert_eq!(
            key,
            format!(
                "{}/v2/db-v6/default/manifest.json",
                crate::identity::SYNC_REMOTE_ROOT
            )
        );
    }
    ...
    fn s3_key_matches_expected_pattern() {
        ...
        assert_eq!(parts[0], crate::identity::SYNC_REMOTE_ROOT);
